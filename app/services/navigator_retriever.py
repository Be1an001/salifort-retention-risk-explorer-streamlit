...
class RetrievalExpectationGroup:
    description: str
...
class RetrievalQuerySpec:
    query: str
    description: str
    expected_groups: tuple[RetrievalExpectationGroup, ...] = ()
...
def get_retrieval_evaluation_queries() -> list[RetrievalQuerySpec]:
    return [
        RetrievalQuerySpec(
            ...
            expected_groups=(
                RetrievalExpectationGroup(
                    description="Public model truth signal",
        ...
        RetrievalQuerySpec(
            ...
            expected_groups=(
                RetrievalExpectationGroup(
                    description="Public threshold truth signal",
                    expected_truth_tags=("public_model_truth",),
                ),
            ),
        ),
        RetrievalQuerySpec(
            ...
            description=(
                "Should retrieve fallback truth and the governed drift explaining why it must stay "
                "separate from canonical artifact-backed/final model truth."
            ),
            expected_groups=(
                RetrievalExpectationGroup(
                    description="Fallback-truth chunk",
                    expected_truth_tags=("fallback_truth",),
                ),
                RetrievalExpectationGroup(
                    description="Fallback-vs-runtime drift chunk",
        ...
        RetrievalQuerySpec(
            ...
            expected_groups=(
                RetrievalExpectationGroup(
                    description="Manager Action View routing hint",
        ...
        RetrievalQuerySpec(
            ...
            expected_groups=(
                RetrievalExpectationGroup(
                    description="Public-selection drift chunk",
